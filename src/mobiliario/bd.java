...
public class bd extends javax.swing.JDialog {
     ...
     * Creates new form bd
     */
    public bd(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
         ////////////ICono//////////////
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Inventory-icon.png"))); // NOI18N
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Actions-arrow-right-icon.png"))); // NOI18N
        jLabel1.setText("Presione el botón Respaldar para generar un Backup de la Base de Datos. Guarde el archivo en una ruta segura.");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int status = fileChooser.showSaveDialog(null); //fileChooser
        if (status == 0) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                bd dialog = new bd(new javax.swing.JFrame(), true);
