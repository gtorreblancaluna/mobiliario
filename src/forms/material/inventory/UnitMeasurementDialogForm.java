...
public class UnitMeasurementDialogForm extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UnitMeasurementDialogForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                UnitMeasurementDialogForm dialog = new UnitMeasurementDialogForm(new javax.swing.JFrame(), true);
